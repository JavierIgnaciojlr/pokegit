...
VALUES (133, '2021-04-12', 'La Florida', false, 15.6, 0.3);
INSERT INTO mis_pokemones (pokedex, fecha_captura, lugar, huevo, peso, estatura)
VALUES (134, '2021-04-12', 'Bosque Panul', false, 25.6, 0.8);

SELECT * FROM mis_pokemones ORDER BY lugar ASC LIMIT 5;
...
SELECT rocket AS capturado_por_los_chichigan FROM pokemones LIMIT 2;
--Agrupar por tipo1
SELECT tipo1, COUNT(*) FROM pokemones GROUP BY tipo1;
SELECT tipo2, COUNT(*) FROM pokemones GROUP BY tipo2;

--Ejecutrar consulta con order by fast sharing 
